...
- Async notification queue and ops APIs (Sprint 13-14)
- Dockerfile + CI workflow (Sprint 13-14)
...
- `POST /api/v1/notifications/queue` (school_admin/principal)
- `GET /api/v1/notifications/queue` (authenticated)
...
- `GET /api/v1/ops/readiness` (public health/readiness)
- `GET /api/v1/ops/audit-logs` (super_admin/school_admin/principal)
